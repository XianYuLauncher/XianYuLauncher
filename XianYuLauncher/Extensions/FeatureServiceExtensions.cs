...
internal static class FeatureServiceExtensions
{
    public static IServiceCollection AddFeatureServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IAgentToolHandler, SleepToolHandler>();
        ...
        services.AddSingleton<IAgentToolHandler, InstallModpackToolHandler>();
        ...
        services.AddSingleton<IModpackDownloadQueueService, ModpackDownloadQueueService>();
