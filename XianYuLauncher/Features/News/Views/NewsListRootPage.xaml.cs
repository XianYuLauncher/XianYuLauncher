...
public sealed partial class NewsListRootPage : Page
{
    ...
    private NewsListViewModel? _attachedViewModel;

    public NewsListViewModel ViewModel { get; private set; }

    public NewsListRootPage()
    {
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        SetViewModel(e.Parameter as NewsListViewModel ?? ViewModel);
    ...
    public void ResetEmbeddedVisualState()
    {
        ...
        FiltersPanel.Opacity = 1;
        FiltersPanel.Translation = default;
        NewsListView.Opacity = 1;
        NewsListView.Translation = default;
    }

    private void SetViewModel(NewsListViewModel viewModel)
    {
