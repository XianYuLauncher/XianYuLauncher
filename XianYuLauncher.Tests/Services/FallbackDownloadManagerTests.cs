...
public class FallbackDownloadManagerTests : IDisposable
{
    ...
    public async Task DownloadFileForCommunityAsync_CurseForgeCdn_SkipsUnsupportedSources()
    {
        ...
        var originalUrl = "https://edge.forgecdn.net/files/7396/228/CreateTheBrassConcerto-Beta0.7.1hotfix.zip";
        ...
        capturedUrls[0].Should().Be("https://edge.forgecdn.net/files/7396/228/CreateTheBrassConcerto-Beta0.7.1hotfix.zip");
        capturedUrls[1].Should().Be("https://mod.mcimirror.top/files/7396/228/CreateTheBrassConcerto-Beta0.7.1hotfix.zip");
    }
