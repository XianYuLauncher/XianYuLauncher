...
public static class MinecraftFileConsts
{
    ...
    public const string ModrinthIndexJson = "modrinth.index.json";
    public const string FabricModJson = "fabric.mod.json";
    public const string ModpackDefaultName = "modpack.mrpack";
}