![XianYu Launcher Readme Hero](/XianYuLauncher/Assets/ReadmeHero_en-US.png)
...
- **Launcher AI**: Compatible with OpenAI Chat Completions API-compatible services to automatically complete game, mod installation, crash repair and more *(requires self-configuration of Chat Completions API base URL and API key)*.
